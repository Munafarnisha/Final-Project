...
<tr><td style="font-size:20px; font-family:Lucida Calligraphy; color:#09F">Category</td></tr>
<?php
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;font-size:18px;font-weight:bold;'><a href='subcat.php?catid=$data[0]'>$data[1]</a></td></tr>";
...
<tr><td colspan="3"><span class="middletext" style="color:#52e03d;font-weight:bold;">Pack Name:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[1];?></td></tr>
...
<tr><td  colspan="3" height="90px"><span class="middletext" style="color:#52e03d">Category:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $data[10];?>
 <br/>
  <span class="middletext" style="color:#52e03d;font-weight:bold;">Subcategory:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[12];?>
  <br/>
   <span class="middletext" style="color:#52e03d;font-weight:bold;">Price:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <span class="middletext" style="color:red;font-weight:bold;">RS:</span>&nbsp;<?php echo $data[4];?>&nbsp;/-
</td></tr>
<tr><td colspan="3"><p><?php echo $data[8];?></p></td></tr>
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><button type="button" class="btn btn-info"  name="sbmt" >Enquiry</button></a></td></tr>
</table>
</td>
</tr>
</table>
