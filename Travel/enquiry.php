...
<tr><b><td  style="font-size:20px; font-family:Lucida Calligraphy; color:#09F">Category</td></b></tr>
<?php
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;font-weight:bold;font-size:17px;'><a href='subcat.php?catid=$data[0]'>$data[1]</a></td></tr>";
...
<tr><td style="position:relative;left:280px;font-weight:bold;text-shadow:1px 1px 2px black;font-size:28px; color:#09F;">Enquiry</td></tr>
...
<tr><td colspan="3"><span class="middletext"style="color:#52e03d;font-weight:bold;">Package Id:</span>&nbsp;&nbsp;&nbsp;<?php echo $data[0];?></td></tr>
<tr><td colspan="3" style="color:red;font-weight:bold;"> <span class="middletext"style="color:#52e03d;font-weight:bold;">Pack Name:</span>&nbsp;&nbsp;&nbsp;<?php echo $data[1];?></td></tr>
...
<tr><td>&nbsp;</td><td ><button type="button" class="btn btn-info"  name="sbmt" >Submit</button></td></tr>
