...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;font-weight:bold;'><a href='subcat.php?catid=$data[0]'>$data[1]</a></td></tr>";
...
<tr><td style="position:relative;left:280px;font-weight:bold;text-shadow:1px 1px 2px black;font-size:28px; color:#09F;">Packages</td></tr>
