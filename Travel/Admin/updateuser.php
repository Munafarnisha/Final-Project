...
<tr><td class="lefttxt">Select User</td><td><select style="width:180px;" name="t1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Type of User</td><td><select style="width:180px;" name="s1" required /><option value="">Select</option>
