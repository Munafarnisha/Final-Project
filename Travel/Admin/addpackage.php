...
<tr><td class="lefttxt">Package Name</td><td><input style="width:180px;" type="text" name="t1" required pattern="[a-zA-z _]{3,50}" title"Please Enter Only Characters between 3 to 50 for Package Name" /></td></tr>
...
<tr><td class="lefttxt">Package Price</td><td><input style="width:180px;" type="text" name="t8" /></td></tr>
...
<tr><td class="lefttxt">Details</td><td><textarea style="width:180px;" name="t7"></textarea></td></tr>
<tr><td>&nbsp;</td><td ><input type="submit" class="btn btn-info" value="SAVE" name="sbmt" /></td></tr>
