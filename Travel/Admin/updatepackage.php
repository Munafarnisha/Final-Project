...
<tr><td class="lefttxt">Select Package</td><td><select style="width:180px;" name="s1" required/><option value="">Select</option>
...
</select></tr><tr><td align=right>
<input type="submit" style="position:relative;left:180px;"  class="btn btn-info" value="Show" name="show" formnovalidate/></td></tr>
<?php
if(isset($_POST["show"]))
{
$cn=makeconnection();
...
<tr><td class="lefttxt">Package Name</td><td><input style="width:180px;" type="text"  value="<?php if(isset($_POST["show"])){ echo $Packname ;} ?> " name="t1" required pattern="[a-zA-z _]{1,50}" title"Please Enter Only Characters between 1 to 50 for Package Name"/></td></tr>
<tr><td class="lefttxt">Select Category</td><td><select style="width:180px;" name="t2" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Select Subcategory</td><td><select style="width:180px;" name="t3" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Package Price</td><td><input style="width:180px;" type="text" name="t8" value="<?php if(isset($_POST["show"])){ echo $Packprice ;} ?> " /></td></tr>

<tr><td class="lefttxt">Old Pic</td><td><img style="width:180px;" src="packimages/<?php echo @$Pic1; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Old Pic</td><td><img style="width:180px;"  src="packimages/<?php echo @$Pic2; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Old Pic</td><td><img style="width:180px;" src="packimages/<?php echo @$Pic3; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Details</td><td><textarea style="width:180px;" name="t7" /><?php if(isset($_POST["show"])){ echo $Detail ;} ?></textarea></td></tr>
<tr><td>&nbsp;</td><td ><input type="submit" value="Update" class="btn btn-info" name="sbmt" /></td></tr>
