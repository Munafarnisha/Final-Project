...
<tr><td class="lefttxt">Type of User</td><td><select   style="width:180px;" name="s1" required><option value="">Select</option><option value="Admin">Admin</option><option value="General">General</option></select></td></tr>
