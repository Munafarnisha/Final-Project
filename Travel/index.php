...
<html>
<head>
<title>ASATH TRAVELS | HOME</title>
	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">		  
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <button type="button" class="btn btn-info" name="sbmt">Read More</button></a></div> 
		 </div>
	 </div>
</div>
<!--/About-->
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/<?php echo $data[3]; ?>" width="300px" height="300px" >
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">ASATH TRAVELS</h4>
						<p style="color:#52e03d">NEED HELP BOOKING PACKAGE<br/>&nbsp;
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span><div style="position:relative;bottom:20px;left:30px;border:1px solid transparent;">(+91) 9779730479&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 7696303090</div></h5>
						<h5 style="color:#000"><span class="img2"></span><a style="position:relative;bottom:20px;left:30px;border:1px solid transparent;" "href="#">info@Asath.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@asath.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>
						<div style="position:relative;bottom:20px;left:30px;border:1px solid transparent;">Asath Travels,Theni-625531</div></h5>
                        <br/>
...
?>
					  <form method="post">
                      <table border="0" style="margin-left:100px;" width="700px" height="500px">
                      <tr><td align="left"> <input type="text" style="width:330px" class="text" value=" Name"  name="t1" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Name';}" required pattern="[a-zA-z1 _]{1,50}" title"Please Enter Only Characters and numbers between 1 to 50 for Name"></td></tr>
					 ...
					 <tr><td align="left"><textarea style="width:330px"onFocus="if(this.value == 'Message') this.value='';" name="t4" onBlur="if(this.value == '') this.value='Enter Message Here';" required/ >Message</textarea></td></tr>
					  <tr><td align="left"><div style="position:relative;right:370px;"><input type="submit" value="Send message" name="sbmt"><div></td></tr></table>
					  <div class="clearfix"></div>
					   </form>
				   </div>
				  <div class="clearfix"></div>
